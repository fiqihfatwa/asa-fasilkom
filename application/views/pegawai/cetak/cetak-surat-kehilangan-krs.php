...
<html>
  ...
  <br><br>
		<div style="margin-left:80px;margin-right:80px; margin-top:120px;font-size:12pt">
            ...
            <h3>SURAT PERMOHONAN KEHILANGAN <br>KARTU RENCANA STUDI (KRS)</h3><br><br><br><br>
           ...
           <tr>
            ...
            <p>Mengajukan surat permohonan untuk keperluan pengganti kehilangan Kartu Rencana Studi (KRS) Semester <?php echo $isi['semester']?> Tahun Ajaran <?php echo $isi['tahun_ajaran'] ?>.</p>
