...
<html>
  ...
  <br><br>
		<div style="margin-left:80px;margin-right:80px; margin-top:120px;font-size:12pt">
            ...
            <center style="margin-top:-10px"> Nomor  : &emsp;&emsp;/<?php echo $kode?>/LLS/<?php echo $tahuns?></center><br><br><br>
           ...
           <tr>
            ...
            <p>Demikian surat keterangan ini dibuat untuk dapat mengurus KHS dan yang hilang.
