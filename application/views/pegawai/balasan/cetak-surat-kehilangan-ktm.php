...
<html>
  ...
  <br><br>
		<div style="margin-left:80px;margin-right:80px; margin-top:120px;font-size:12pt">
            ...
            <center> Nomor  : &emsp;&emsp;/<?php echo $kode?>/KMS/<?php echo $tahuns?></center><br><br><br>




            Dekan Fakultas Ilmu Sosial dan Ilmu Politik Universitas Sumatera Utara menerangkan bahwa mahasiswa :<br>
            <table>
           ...
           <tr>
            ...
            <p>adalah benar mahasiswa Fakultas Ilmu Sosial dan Ilmu Politik Universitas Sumatera Utara dan aktif kuliah pada semester <?php echo  $isi['semester']  ?>.</p>

            <p>Demikian surat keterangan ini dibuat untuk keperluan mengurus Kartu Tanda Mahasiswa (KTM) yang baru.
