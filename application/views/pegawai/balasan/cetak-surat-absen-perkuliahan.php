...
<html>
  ...
  <br><br>
		<div style="margin-left:80px;margin-right:80px; margin-top:120px;font-size:12pt">
            ...
            <p>adalah benar mahasiswa Fakultas Ilmu Sosial dan Ilmu Politik Universitas Sumatera Utara dan aktif kuliah pada Semester Ganjil Tahun Akademik . . . ./. . . .</p>

            <!--<p> Demikian surat keterangan ini dibuat untuk tidak dapat mengikuti perkuliahan berhubung <?php echo $isi['alasan']?> -->
 </p><br><br>
